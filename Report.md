...
### (2) GPT 對話過程
* 已將與 ChatGPT 討論 CRISP-DM 流程、程式碼撰寫與 debug 的過程匯出為 PDF 檔案，並連同此報告一併壓縮至 ZIP 檔案中繳交。
*(請記得將 pdfCrowd 或其他工具匯出的 PDF 放進資料夾中)*

---

**[請將本報告、對話 PDF 與 4112056003_hw3.py 壓縮成 4112056003_hw3.zip 繳交]**
